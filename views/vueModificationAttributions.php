...
$nbEtabOffrantChambres = $model->obtenirNbEtabOffrantChambres($connexion);
...
if ($action == 'validerModifAttrib')
{
   ...
   $model->modifierAttribChamb($connexion, $idEtab, $idGroupe, $nbChambres);
}
...
class='tabQuadrille'>";
   ...
   $req = $model->obtenirReqEtablissementsOffrantChambres();
   ...
   $req = $model->obtenirReqIdNomGroupesAHeberger();
