...
constraint PK_ETA primary key(id)
)ENGINE=INNODB;
DESC Etablissement;
...
constraint PK_GRO primary key(id)
)ENGINE=INNODB;
DESC Groupe;
...
constraint PK_ATT primary key(idEtab,idGroupe)
-- constraint fk1_Attribution foreign key(idEtab) references 
